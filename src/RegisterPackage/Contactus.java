...
@Test(priority=2)
  ...
  {		
	...
	//System.out.println("this is contact us");
	driver.findElement(By.xpath("//*[@id='contact-link']/a")).click();
		...
		driver.findElement(By.xpath("//*[@id='message']")).sendKeys("test mail");
		...
		if (driver.getPageSource().contains("Your message has been successfully sent to our team."))
		  {
			  System.out.println("Contact us was successful");
		  }
		  else
			{
			  System.out.println("Contact us was failed");
			}
